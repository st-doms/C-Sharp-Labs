...
{// start definistion of functions in the namespace
    class sample // this means create me a template called program
    {//start of definistion of the Program object
        ...
        {//start function definistion
            ...
            int neverGoingToBeAssignedAValue = Convert.ToInt32(numToCauseException); // the function toint32 will throw an exception as it can not handle the LETTER f!!!
